...
<?php if ($posts): ?>
    ...
    <?php foreach ($posts as $item): ?>
        ...
        <li class="comment" style="padding:10px 10px 10px 10px;height:160px;">
            ...
            <div class="comment-info" style="padding:0px 10px 10px 10px;margin-left:220px;">
                    ...
                    <?php $form = ActiveForm::begin([
                            ...
                            <?= $form->field($model, 'description')
                                ->textarea(['rows' => 3,
                                    ...
                                    'class' => 'form-control',
                                    'style' => 'font-weight:200;padding:0px 0px 0px 0px;width:70%',
                                ])
                                ->label(Yii::t('post','News respectfully post. Thank you.'),
                                    ['style' => 'font-weight:50;padding:0px 10px 10px 0px;width:70%',]) ?>
...
<!--                    </div>-->
                ...
                <?php else: ?>
                    ...
                    <p style="margin: 0px 0px 0px 0px"><?php echo Html::encode($item['description']); ?></p>
